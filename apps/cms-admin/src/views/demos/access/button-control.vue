...
<template>
  ...
  >
    ...
    <ElCard class="mb-5" header="组件形式控制 - 权限码">
    ...
    <ElCard class="mb-5" header="函数形式控制">
    ...
    <ElCard class="mb-5" header="指令方式 - 权限码">
    ...
    <ElCard v-if="accessMode === 'frontend'" class="mb-5" header="指令方式 - 角色">
