      ...
      <template #header>
        <div class="flex items-center justify-between">
          ...
          <div class="flex items-center gap-2">
            <ElSwitch v-model="scrollEnabled" @change="toggleScrollToError" />
            <span>启用滚动到错误字段</span>
          </div>
        </div>
      </template>
      ...
      <div class="space-y-4">
        ...
        <div class="rounded border p-4">
          ...
          <div class="flex flex-wrap gap-2">
            <ElButton type="primary" @click="testValidateAndSubmit">
              测试 validateAndSubmitForm()
            </ElButton>
            <ElButton @click="testValidate"> 测试 validate() </ElButton>
            <ElButton @click="testValidateField"> 测试 validateField() </ElButton>
          </div>
        ...
        <div class="rounded border p-4">
          ...
          <div class="flex flex-wrap gap-2">
            <ElButton @click="fillPartialData"> 填充部分数据 </ElButton>
            <ElButton @click="() => formApi.resetForm()"> 清空表单 </ElButton>
          </div>
          <div class="mt-2 text-xs text-gray-500">
