...
<template>
  <Page description="用于前端简单的拖动校验场景" title="滑块校验">
    ...
    <ElCard class="mb-5" header="自定义圆角">
      <div class="flex items-center justify-center p-4 px-[30%]">
        <SliderCaptcha
          ref="el2"
          class="rounded-full"
    ...
    <ElCard class="mb-5" header="自定义背景色">
      <div class="flex items-center justify-center p-4 px-[30%]">
        <SliderCaptcha
          ref="el3"
          :bar-style="{
    ...
    <ElCard class="mb-5" header="自定义拖拽图标">
      <div class="flex items-center justify-center p-4 px-[30%]">
    ...
    <ElCard class="mb-5" header="自定义文本">
      <div class="flex items-center justify-center p-4 px-[30%]">
        <SliderCaptcha
          ref="el5"
          success-text="成功"
    ...
    <ElCard class="mb-5" header="自定义内容(slot)">
      <div class="flex items-center justify-center p-4 px-[30%]">
